export const quizValidatorFunction = (props) => {
  ...
  if (typeof generalBackgroundColor !== "string") {
    throw new Error(
      "React BuzzFeed Quiz's 'generalBackgroundColor' prop must be a string."
    );
  }

  if (typeof generalFontColor !== "string") {
    throw new Error(
      "React BuzzFeed Quiz's 'generalFontColor' prop must be a string."
    );
  }
          ...
          for (let i = 0; i < questions.length; i++) {
            if (!questions[i].question) {
              ...
              if (typeof questions[i].question !== "string") {
                ...
                if (
                  !questions[i].backgroundColor ||
                  typeof questions[i].backgroundColor === "string"
                ) {
                  if (
                    !questions[i].fontColor ||
                    typeof questions[i].fontColor === "string"
                  ) {
                    if (
                      !questions[i].imageAttribution ||
                      typeof questions[i].imageAttribution === "string"
                    ) {
                      if (
                        !questions[i].answerArrangement ||
                        typeof questions[i].answerArrangement === "string"
                      ) {
                        if (
                          !questions[i].questionRelativeToImage ||
                          typeof questions[i].questionRelativeToImage ===
                            "string"
                        ) {
                                  ...
                                  for (
                                    ...
                                    if (
                                      ...
                                      if (
                                        ...
                                        if (
                                          !questions[i].answers[j].fontColor ||
                                          typeof questions[i].answers[j]
                                            .fontColor === "string"
                                        ) {
                                          if (
                                          ...
                                          throw new Error(
                                            "The associated value of the 'fontColor' key of every object in the 'answers' array of every object in React BuzzFeed Quiz's 'questions' prop array must be a string."
                                          );
                                        }
                                      } else {
                                        throw new Error(
                                          "The associated value of the 'backgroundColor' key of every object in the 'answers' array of every object in React BuzzFeed Quiz's 'questions' prop array must be a string."
                                        );
                                      }
                                    }
                                  }
                          ...
                          throw new Error(
                            "The associated value of the 'questionRelativeToImage' key of every object in React BuzzFeed Quiz's 'questions' prop array must be a string."
                          );
                        }
                      } else {
                        throw new Error(
                          "The associated value of the 'answerArrangement' key of every object in React BuzzFeed Quiz's 'questions' prop array must be a string."
                        );
                      }
                    } else {
                      throw new Error(
                        "The associated value of the 'imageAttribution' key of every object in React BuzzFeed Quiz's 'questions' prop array must be a string."
                      );
                    }
                  } else {
                    throw new Error(
                      "The associated value of the 'fontColor' key of every object in React BuzzFeed Quiz's 'questions' prop array must be a string."
                    );
                  }
                } else {
                  throw new Error(
                    "The associated value of the 'backgroundColor' key of every object in React BuzzFeed Quiz's 'questions' prop array must be a string."
                  );
                }
              }
            }
